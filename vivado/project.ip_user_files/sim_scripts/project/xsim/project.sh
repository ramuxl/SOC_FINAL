...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L processing_system7_bfm_v2_0_5 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_9 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_8 -L fifo_generator_v13_1_0 -L axi_data_fifo_v2_1_7 -L axi_crossbar_v2_1_9 -L blk_mem_gen_v8_3_2 -L axi_lite_ipif_v3_0_3 -L interrupt_control_v3_1_3 -L axi_gpio_v2_0_10 -L axi_protocol_converter_v2_1_8 -L unisims_ver -L unimacro_ver -L secureip --snapshot project xil_defaultlib.project xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim project -key {Behavioral:sim_1:Functional:project} -tclbatch cmd.tcl -log simulate.log
}
